package errors.outofmemory.javaexceptionhandling;
...
public class Logging {
	...
	/**
	 * Outputs any kind of Object. Uses ReflectionToStringBuilder from Apache
	...
	public static void log(Object value) {
		...
		if (ClassUtils.isPrimitiveOrWrapper(value.getClass())) {
			...
			System.out.println(new ReflectionToStringBuilder(value,
	...
	/**
	 * Outputs passed in Throwable exception or error instance. Can be
	 * overloaded if expected parameter should be specified.
	 *
	 * @param throwable
	 *            Throwable instance to output.
	 */
	...
	/**
	 * Outputs passed in Throwable exception or error instance. Includes
	 * Throwable class type, message, stack trace, and expectation status.
	 *
	 * @param throwable
	 *            Throwable instance to output.
	 * @param expected
	 *            Determines if this Throwable was expected or not.
	 */
	public static void log(Throwable throwable, boolean expected) {
		System.out.println(String.format("[%s] %s", expected ? "EXPECTED"
				: "UNEXPECTED", throwable.toString()));
	...
	public static void lineSeparator() {
		lineSeparator(separatorInsertDefault, separatorLengthDefault,
				separatorCharacterDefault);
	}
	...
	/**
	 * Outputs a dashed line separator with inserted text centered in the
	 * middle.
	 *
	 * @param insert
	 *            Inserted text to be centered.
	 * @param length
	 *            Length of line to be output.
	 * @param separator
	 *            Separator character.
	 */
	public static void lineSeparator(String insert, int length, char separator) {
		...
		if (insert.length() == 0) {
			...
			output = String.format("%s %s %s",
					getRepeatedCharString(separator, left), insert,
					getRepeatedCharString(separator, right));
		}
